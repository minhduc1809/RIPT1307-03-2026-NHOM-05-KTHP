					...
					<Row gutter={[48, 48]} align='middle'>
						<Col xs={24} lg={12}>
							...
							<p className={styles.heroSubtitle}>
								Tạo các biểu mẫu động, thu thập dữ liệu và quản lý quy trình phê duyệt một cách dễ dàng. Giải phóng
								doanh nghiệp khỏi những thủ tục giấy tờ thủ công.
							</p>
							<div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
								<Button
									...
									style={{
										...
										fontSize: '18px',
										fontWeight: 'bold',
										background: 'linear-gradient(to right, #565e74, #4a5268)',
										border: 'none',
										boxShadow: '0px 12px 32px rgba(42, 52, 57, 0.06)',
									}}
								>
									Bắt đầu ngay
								</Button>
						...
						<Col xs={24} md={12}>
							...
							<div className={styles.stepItem}>
								...
								<div>
									<h4>Tạo biểu mẫu</h4>
									<p>
										Sử dụng trình kéo thả trực quan để thiết kế giao diện nhập liệu phù hợp với nhu cầu riêng của bạn.
									</p>
								</div>
							</div>
							<div className={styles.stepItem}>
								...
								<div>
									<h4>Gửi dữ liệu</h4>
									<p>
										Người dùng điền thông tin và gửi yêu cầu từ bất kỳ thiết bị nào, dữ liệu được bảo mật tuyệt đối.
									</p>
								</div>
							</div>
							<div className={styles.stepItem}>
								...
								<div>
									...
									<p>
										Hệ thống tự động chuyển tiếp đến người có thẩm quyền để xử lý và hoàn tất quy trình ngay tức thì.
									</p>
								</div>
							</div>
						</Col>
				...
				<section className={styles.useCasesSection}>
					<div className={styles.useCasesContainer}>
						<div className={styles.sectionTitle} style={{ textAlign: 'center', marginBottom: '64px' }}>
							...
							<p style={{ color: '#566166' }}>
								Triển khai nhanh chóng cho các nhu cầu quản trị doanh nghiệp phổ biến nhất.
							</p>
						</div>
						<Row gutter={[32, 32]}>
							<Col xs={24} md={8}>
								<div className={styles.caseCard}>
									...
									<div className={styles.caseHeader}>
										...
										<span className='material-symbols-outlined' style={{ color: '#565e74' }}>
											arrow_forward
										</span>
									</div>
